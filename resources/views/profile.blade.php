                    ...
                    <div class="modal-body" id="modal-body-content">
                      <form method="POST" action="/management/add_role/" class="form-container" id="updateStudentForm">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">Send</button>
                                    ...
                                    <div class="modal fade" id="chatModal{{ $chat->cht_to }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">
                                                        {{ $chat->first_name }} {{ $chat->last_name }}</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <form id="chatForm" action="{{ route('send-chat') }}"
                                                        method="post">
                                                        @csrf
                                                        <input type="hidden" name="recipient_id"
                                                            value="{{ $chat->cht_from }}">
                                                        <div class="d-flex mx-auto">
                                                            <input class="form-control me-2" style="flex-basis: 100%"
                                                                name="message" id="message" required></input>
                                                            <button type="submit" style="flex-basis: 20%"
                                                                class="btn btn-primary mt-2">Send</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                @empty
                                    <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">No recent
                                        chats found.</li>
                                @endforelse
                                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
