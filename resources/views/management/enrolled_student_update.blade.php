            ...
            <div class="card-body pt-4 p-3">
                <form method="POST" action="{{ url('/management/enrolled_student_update/' . $enrolledStudent->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('gender') border border-danger rounded-3 @enderror">
                                    <select class="form-control" id="gender" name="gender" required>
                                        <option value="{{ $enrolledStudent->gender }}" selected>{{
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('mobile_number') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" maxlength="10" placeholder="9123456789"
                                        ...
                                        value="{{ $enrolledStudent->mobile_number }}" required>
                                    @error('mobile_number')
                                    <p class=" text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Update Enrollee'
                            }}</button>
                    </div>
                </form>
            </div>
